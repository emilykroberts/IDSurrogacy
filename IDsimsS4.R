...
setwd("./results/supplement/TableS4") # save supplemental simulations results in TableS4 folder

# corresponds to Supplement Table 4 tableS4results.csv - change diffscale1323 to FALSE
# simulate data
set.seed(1 + array_id)
