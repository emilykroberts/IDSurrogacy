...
#' @param shape13 shape of Weibull distribution
#' @param scale13 scale of Weibull distribution
#' @param c13 frailty coefficient
#' @param beta13_1 covariate coefficient
#' 
#' @return cumulative hazard
#'
#' @examples
#' example(cLambda13_frailty_lk(x = 1, xdata1 = 0, omega2 = 1, 
#' shape13 = 1, scale13 = 1, c13 = 1, beta13_1 = 0))
