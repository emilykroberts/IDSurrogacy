...
#' c23_0 = 1, theta23_0 = 0))
like13_omega_i = function(omega13_z0, omega23_z0, i, scale13_0, dat0, shape13_0, c13_0, 
  ...
  d = ((1 / shape23_0 - 1) * (sum(log(dat0$y23[i] ^ dat0$s23[i]), na.rm = T)) -
         scale23_0 * shape23_0 * sum(dat0$y23[i] ^ (1 / shape23_0) * exp(c23_0 * omega23_z0
         ), na.rm = T))
